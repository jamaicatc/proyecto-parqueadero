...
public class PagoService {
    ...
    private void generarReporte(List<Pago> pagos, String titulo) {
        ...
        reporte.append("------------------------------------------\n");
        reporte.append("Ingresos por Estacionamiento: $").append(String.format("%.2f", totalEstacionamiento)).append("\n");
        reporte.append("Ingresos por Membresías: $").append(String.format("%.2f", totalMembresias)).append("\n");
        reporte.append("TOTAL GENERAL: $").append(String.format("%.2f", totalGeneral)).append("\n\n");
        
        reporte.append("DESGLOSE POR TIPO DE VEHÍCULO\n");
        reporte.append("------------------------------------------\n");
        reporte.append("Automóviles: $").append(String.format("%.2f", totalAutomoviles));
        if (totalGeneral > 0) {
            reporte.append(" (").append(String.format("%.1f", (totalAutomoviles/totalGeneral)*100)).append("%)");
        }
        reporte.append("\n");
        
        reporte.append("Motos: $").append(String.format("%.2f", totalMotos));
        if (totalGeneral > 0) {
            reporte.append(" (").append(String.format("%.1f", (totalMotos/totalGeneral)*100)).append("%)");
        }
        reporte.append("\n");
        
        reporte.append("Camiones: $").append(String.format("%.2f", totalCamiones));
        if (totalGeneral > 0) {
        ...
        for (int i = 0; i < pagos.size(); i++) {
            ...
            reporte.append("Monto: $").append(String.format("%.2f", pago.getMonto())).append("\n");
        }
